...
import AssignAppointmentModal from "../../medical secretary/components/Appointments/AssignAppointmentModal";

const AdminPending = ({ allAppointments, setAllAppointments }) => {
  const { did } = useParams();
