...
import { PassFill, WalletFill, CheckAll } from 'react-bootstrap-icons';
        ...
        <Container className="appointment-form-container">
            ...
            <div className="steps d-flex flex-wrap flex-sm-nowrap justify-content-between padding-top-2x padding-bottom-1x">
                ...
                <div className={`step ${step >= 2 ? "completed" : ""} ${step === 2 ? "active" : ""}`}>
                    <div className="step-icon-wrap">
                        <div className="step-icon"><WalletFill size={20}/></div>
                    </div>
            ...
            {step === 3 && (
                <div>
                    <h4>Step 3: Finalizing Information</h4>
                    <div>
                        <div>
                            <p>Date: {date}</p>
                            <p>Time:{time}</p>
                            ...
                            {/* If merong proof of payment */}
                            {proofOfPayment && (
                                <p>Proof of Payment:{proofOfPayment.name}</p>
                            )}
                        </div>
                    </div>
                </div>
            ...
            <div className="d-flex justify-content-between mt-4">
                ...
                {step < 3 && <Button variant="primary" onClick={handleNextStep}>Next</Button>}
                {step === 3 && <Button variant="success" onClick={createAppointment}>Submit</Button>}
            </div>
        </Container>
        </>
    );
