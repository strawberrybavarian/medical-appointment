          ...
          <div className="row">
            <div className="col-xl-4 col-md-4 mb-30">
              <div className="single-cta">
                ...
                <div className="cta-text">
                  <h4>Find us</h4>
                  <span>Molino boulevard,Molino 3 , Bacoor, Philippines</span>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-4 mb-30">
            ...
            <div className="col-xl-4 col-md-4 mb-30">
              <div className="single-cta">
                ...
                <div className="cta-text">
                  <h4>Mail us</h4>
                  <span>molinopolyclinic@gmail.com</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="col-xl-4 col-lg-4 mb-50">
              <div className="footer-widget">
                <div className="footer-logo">
                  <a href="index.html"><img src={image.logo} class alt="logo" /></a>
                </div>
